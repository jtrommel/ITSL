...
With this function we generate 100 data points, adding a normally distributed error term $\epsilon ~ N(0,sig)$. From this data set we sample 2/3 points for the training set and the rest (1/3) forms the test set.
